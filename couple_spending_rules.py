...
def get_luxury_over_basic(base_spending: float, luxury_compound_rate: float):
    ...
    def luxury_over_basic(deltas: model.couple_deltas_state, previous_funds: model.couple_funds_state, previous_deltas: model.couple_deltas_state):
        if (deltas.partner1_deltas.gross_salary == 0 and deltas.partner2_deltas.gross_salary == 0):
        ...
        if (previous_luxury < 0):
                ...
                new_spending = (1 + luxury_compound_rate) * previous_deltas.household_spending
